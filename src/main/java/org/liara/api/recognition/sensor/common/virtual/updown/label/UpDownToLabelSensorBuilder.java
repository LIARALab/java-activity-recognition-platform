...
public class UpDownToLabelSensorBuilder
{
  ...
  private SapaRepositories.@Nullable Boolean _inputs;
  ...
  public SapaRepositories.@Nullable Boolean getInputs () {
    return _inputs;
  }

  @Autowired
  public void setInputs (final SapaRepositories.@Nullable Boolean inputs) {
    _inputs = inputs;
  }
