...
import org.liara.api.controller.collection.ChildrenNodeCollectionController;
...
public class ChildrenNodeRelation
  implements RestSubCollectionRelation<Node>
{
  ...
  @Autowired
  public ChildrenNodeRelation (@NonNull final ApplicationContext applicationContext) {
  ...
  )
  {
    return _applicationContext.getBean(
      ChildrenNodeCollectionController.class,
