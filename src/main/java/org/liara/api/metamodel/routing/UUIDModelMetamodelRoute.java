...
public class UUIDModelMetamodelRoute
  extends ModelMetamodelRoute
{
  @NonNull
  private final UUID _identifier;

  public UUIDModelMetamodelRoute (
    @NonNull final String pathElement, @NonNull final ModelController<?> modelController, @NonNull final UUID identifier
  )
  {
