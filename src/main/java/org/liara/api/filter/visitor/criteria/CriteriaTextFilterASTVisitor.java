...
{  
  ...
  @NonNull
  private final SimplifiedCriteriaExpressionSelector<String> _field;

  public CriteriaTextFilterASTVisitor (@NonNull final SimplifiedCriteriaExpressionSelector<String> field) {
    _field = field;
  }
