...
public class LabelStateMutationSchema
  extends StateMutationSchema
{
  ...
  @Override
  public LabelState apply (@NonNull final EntityManager manager) {
    final LabelState result = (LabelState) getState().resolve(manager);
