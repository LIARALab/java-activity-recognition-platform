...
public class StateCorrelationsTable
  extends TableDescription
{
  ...
  @NonNull
  public final ColumnDescription startStateIdentifier = column(
    "start_state_identifier", Primitives.INTEGER
  );

  @NonNull
  public final ColumnDescription endStateIdentifier = column(
    "end_state_identifier", Primitives.INTEGER
  );
