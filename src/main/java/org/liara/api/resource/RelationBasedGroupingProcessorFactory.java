...
import org.liara.rest.request.jpa.EntityGroupingHandlerFactory;
...
public class RelationBasedGroupingProcessorFactory
{
  @NonNull
  ...
  @NonNull
  private final EntityGroupingHandlerFactory _entityGroupingHandlerFactory;

  @Autowired
  public RelationBasedGroupingProcessorFactory (
    @NonNull final RelationManager relationManager,
    @NonNull final EntityGroupingHandlerFactory entityGroupingHandlerFactory
  ) {
  ...
  private @NonNull ProcessorExecutor<Operator> createExecutor (
    ...
    handlers.add(_entityGroupingHandlerFactory.getExecutorFor(clazz));
