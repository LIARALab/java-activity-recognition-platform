...
public class ParentNodeCollectionBuilder
  implements Builder<ParentNodeCollection>
{
  @Nullable
  ...
  public ParentNodeCollectionBuilder () {
    _target = null;
    _collectionResourceBuilder = null;
    _context = null;
  }

  public ParentNodeCollectionBuilder (@NonNull final ParentNodeCollectionBuilder toCopy) {
  ...
  @Override
  public @NonNull Class<ParentNodeCollection> getOutputClass () {
    return ParentNodeCollection.class;
  }

  @Override
  public @NonNull ParentNodeCollection build () {
    return new ParentNodeCollection(this);
  }
  ...
  public boolean equals (@Nullable final Object other) {
    ...
    if (other instanceof ParentNodeCollectionBuilder) {
      @NonNull final ParentNodeCollectionBuilder otherChildrenNodeCollectionBuilder =
        (ParentNodeCollectionBuilder) other;
