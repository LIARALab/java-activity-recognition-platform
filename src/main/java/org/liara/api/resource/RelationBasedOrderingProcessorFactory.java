...
public class RelationBasedOrderingProcessorFactory
{
  @NonNull
  ...
  @Autowired
  public RelationBasedOrderingProcessorFactory (
    @NonNull final RelationManager relationManager,
    @NonNull final EntityOrderingHandlerFactory entityOrderingHandlerFactory,
  ...
  private @NonNull ProcessorExecutor<Operator> createExecutor (
    ...
    handlers.add(_entityOrderingHandlerFactory.getExecutorFor(clazz));
