...
*
* A view is only a part of an entity collection that can be returned to a client
* or used for computation.
*/
public class EntityCollectionView<T> {
  ...
  */
  ...
  /**
  * The maximum size allowed for this view. It is the maximum number of
  * elements to display into this view.
  */
  ...
  */
  @NonNull private EntityCollection<T> _parent;

  /**
  * The content of this view.
  */
  @Nullable private Collection<T> _content;
  ...
  */
  public EntityCollectionView (
    @NonNull final EntityCollection<T> parent
  ) {
  ...
  */
  public void update () {
    this._content = this.getParentCollection()
                        .createQuery()
                        .setMaxResults(this._maxSize)
                        .setFirstResult(this._offset)
                        .getResultList();
  }
}
