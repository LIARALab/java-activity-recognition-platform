  ...
  extends Specification
{
  def "it allows you to instantiate an empty tree with the default constructor" () {
    ...
    final LocalNestedSetRepository tree = new LocalNestedSetRepository()
  ...
  def "it allow you to register new nodes into the tree" () {
    ...
    and: "a node"
    final NestedSet node = Mockito.mock(NestedSet.class)
  ...
  def "it allow you to register new nodes as children of a node of the tree" () {
    ...
    and: "a child node"
    final NestedSet child = Mockito.mock(NestedSet.class)
    ...
    tree.addChild(child, tree.getNode(6L))
  ...
  def "it allow to move nodes into the tree" () {
    ...
    tree.addChild(tree.getNode(2L), tree.getNode(1L))
    tree.addChild(tree.getNode(3L), tree.getNode(1L))
    tree.addChild(tree.getNode(4L), tree.getNode(2L))
    tree.addChild(tree.getNode(7L), tree.getNode(6L))
    tree.addChild(tree.getNode(8L), tree.getNode(6L))
    tree.addChild(tree.getNode(6L), tree.getNode(5L))
